...
Languages       & Cython, Python               & C++, Python           & Python                 & Python, C                   & Cython, Python     \\
...
uses Cython for this and Swiginac uses SWIG library. Both don't wrap the entire
library. Pynac requires Sage for coefficient arithmetics, so you can't use
