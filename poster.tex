...
diverged from SymPy and it's unlikely it will be merged with it any time soon.
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Pynac vs. Swiginac}{name=pynacswiginac,column=2,span=1,below=sympysympycore}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Pynac and Swiginac both wrap GiNaC, a C++ library for symbolic mathematics. Pynac
...
it as a standalone library, as opposed to Swiginac.
}
...
three programs miss too many important features to be currently considered
